...
V_REV_ZIP=$REPO/lab_models_v5/models/reverse/lidar_24/guided/best_model.zip
V_FWD_PTH=$REPO/lab_models_v5/models/forward/lidar_24/multiplicative/best_model.policy.pth
V_REV_PTH=$REPO/lab_models_v5/models/reverse/lidar_24/guided/best_model.policy.pth
...
grep -E "Eval num_timesteps|New best" "$REPO/lab_models_v5/.train_logs/reverse.log" | tail -8
...
echo
echo "[post_train] repointing launches: v3 -> v5"
LAUNCHES=(
