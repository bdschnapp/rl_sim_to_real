...
public:
  ...
  /**
   * @brief get trailer hitch (articulation) angle β = θ_truck − θ_trailer [rad]
   * @details Returns 0.0 for non-trailer models. Override in trailer models.
   */
  virtual double getHitchAngle() { return 0.0; }
