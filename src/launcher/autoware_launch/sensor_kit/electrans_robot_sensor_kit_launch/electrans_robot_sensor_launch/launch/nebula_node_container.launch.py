...
def launch_setup(context, *args, **kwargs):
    ...
    nodes.append(
        ComposableNode(
            ...
            remappings=[
                ...
                ("robosense_points", LaunchConfiguration("output_topic")),
    ...
    nodes.append(
        ComposableNode(
            ...
            remappings=[
                ("input", LaunchConfiguration("output_topic")),
...
def generate_launch_description():
    ...
    add_launch_arg("output_topic", "/sensing/pointcloud/lidar", "output topic name")
